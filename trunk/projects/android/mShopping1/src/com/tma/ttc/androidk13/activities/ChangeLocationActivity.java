...
import com.tma.ttc.androidk13.models.MyAddress;
import com.tma.ttc.androidk13.utilities.CommonConfiguration;
import com.tma.ttc.androidk13.utilities.LocationAdapter;
...
public class ChangeLocationActivity extends ListActivity {
	...
	protected Dialog onCreateDialog(int id) {
		// TODO Auto-generated method stub
		switch (id){
		case CommonConfiguration.CHANGE_LOC: 
            ...
            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    ...
                    SharedPreferences mSharePref = getSharedPreferences(CommonConfiguration.PREF_NAME, 0);
                    SharedPreferences.Editor mEditor = mSharePref.edit();
                    mEditor.putFloat(CommonConfiguration.KEY_LAT, new Float(lstAd.get(0).getLat()));
                    mEditor.putFloat(CommonConfiguration.KEY_LNG, new Float(lstAd.get(0).getLng()));
                    mEditor.commit();
                    ...
                    mBundle.putDouble(CommonConfiguration.KEY_LAT, lstAd.get(0).getLat());
                    mBundle.putDouble(CommonConfiguration.KEY_LNG, lstAd.get(0).getLng());
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
			// TODO Auto-generated method stub
			showDialog(CommonConfiguration.CHANGE_LOC);
